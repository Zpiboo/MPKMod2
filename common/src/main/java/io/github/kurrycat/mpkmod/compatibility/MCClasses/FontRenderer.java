...
public class FontRenderer {
    ...
    public static void drawCenteredString(String text, Container parent, Color color, boolean shadow) {
        drawCenteredString(text, parent, color, DEFAULT_FONT_SIZE, shadow);
    }

    public static void drawCenteredString(String text, Container parent, Color color, double fontSize, boolean shadow) {
