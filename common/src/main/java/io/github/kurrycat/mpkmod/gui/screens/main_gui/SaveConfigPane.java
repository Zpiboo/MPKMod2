...
public class SaveConfigPane extends Pane<MainGuiScreen> {
    ...
    private void initComponents() {
        ...
        fileDiv.addChild(r.setPercentFlag(PERCENT.SIZE_X).setThisAnchor(Anchor.BOTTOM_CENTER));
        fileDiv.addChild(filename.setPercentFlag(PERCENT.SIZE_X).setThisAnchor(Anchor.BOTTOM_CENTER));
        fileDiv.addChild(b.setPercentFlag(PERCENT.SIZE_X).setThisAnchor(Anchor.BOTTOM_CENTER));
        addChild(fileDiv.setPercentFlag(PERCENT.POS_X | PERCENT.SIZE_X).setAnchors(Anchor.CENTER_LEFT));
    }
    ...
    private class ConfigFileListItem extends ScrollableListItem<ConfigFileListItem> {
        ...
        public ConfigFileListItem(ConfigFileList parent, String file) {
            ...
            addChild(delete.setThisAnchor(Anchor.CENTER_RIGHT));
        }
