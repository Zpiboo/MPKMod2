package io.github.kurrycat.mpkmod.compatibility.fabric_1_20_2;

import com.mojang.blaze3d.systems.RenderSystem;
import io.github.kurrycat.mpkmod.compatibility.MCClasses.*;
import io.github.kurrycat.mpkmod.compatibility.fabric_1_20_2.mixin.KeyBindingAccessor;
...
public class FunctionCompatibility implements FunctionHolder,
    ...
    public void displayGuiScreen(MPKGuiScreen screen) {
        MinecraftClient.getInstance().setScreen(
                screen == null
                        ? null
                        : new io.github.kurrycat.mpkmod.compatibility.fabric_1_20_2.MPKGuiScreen(screen));
    }
    ...
    public String getCurrentGuiScreen() {
        ...
        if (curr == null)
            return null;
        else if (curr instanceof io.github.kurrycat.mpkmod.compatibility.fabric_1_20_2.MPKGuiScreen) {
            String id = ((io.github.kurrycat.mpkmod.compatibility.fabric_1_20_2.MPKGuiScreen) curr).eventReceiver.getID();
            if (id == null)
                id = "unknown";
